                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell( 
                            ...
                            child: FittedBox(
                                fit: BoxFit.cover,
                                child: Image.asset(harsh[widget.sectors[index].sectorName],
                                  width: a * 0.6,
                                  height:b*0.2,
                                )),
                          ),
                              ...
                              Text(
                                "₹" +
                                    widget.sectors[index].featuredCourses[0]
                                        .price,
                                style: TextStyle(
                                    fontSize: a*0.03, fontWeight: FontWeight.w500),
                              ),
                            ],
                          ),
                          SizedBox(height: b * 0.01),
                          ...
                          InkWell(
                            onTap: (){
                               Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    viewcourses(widget.sectors[index]
                                                        .sectorUuid)));
                            },
                            child: Center(
                                child: 
